...
ggplot(data=annual_incident_prct, aes(x=Year, y=incident, fill=incident)) + geom_bar(stat="identity") + labs(x = "New x label") 
...
annual_incident_prct = annual_incident_prct %>%
  mutate(incident_prcnt = incident/annual_ridership)

annual_incident_prct
ggplot(data = annual_incident_prct, aes(x=Year, y=incident_prcnt, group=1)) + geom_line()
